    ...
    if response.status_code == 200:
        ...
        for section in main_content_sections:
            ...
            if h2_element_last or h2_element_plus:
                article_links = []
                article_tags = section.find_all(
                    "article", class_="card-post -rowdesktop"
                )
                ...
                for article_tag in article_tags:
                    if article_tag.a and article_tag.a.has_attr("href"):
                        ...
                        logging.warning(
                            "No 'href' attribute found in this article tag."
                        )
        ...
        logging.error(
            "Failed to retrieve the web page. Status code: %s",
